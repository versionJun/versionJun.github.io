...
- ### Media 
	...
	- #### [Spotify](https://www.spotify.com/)<a id="spotify"></a>
		
		> SpotX <sup>[[GitHub](https://github.com/SpotX-Official/SpotX)]</sup> - SpotX是一款Windows平台Spotify修改版客户端，具备广告屏蔽、隐藏播客和有声书、阻止自动更新等功能。此外，它还激活了多项实验性特性，支持快速安装和更新，并提供多种安装选项。
